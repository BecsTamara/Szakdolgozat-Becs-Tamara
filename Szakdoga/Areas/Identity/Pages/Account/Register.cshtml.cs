...
namespace Szakdoga.Areas.Identity.Pages.Account
{
    [Authorize(Roles = Roles.Boss)]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required, Display(Name = "Lakcím")]
            public string Address { get; set; }
            [Required, Display(Name = "Felhasználó név")]
            public string UserName { get; set; }
            [EmailAddress]
            [Required, Display(Name = "E-mail")]
            public string Email { get; set; }
            [Required]
            [StringLength(100, ErrorMessage = "A {0} legalább {2} és legfeljebb {1} karakter hosszúságú lehet.", MinimumLength = 6)]
